...
const prod = {img,name,price}
  ...
  <span style={{ fontWeight: "bold", fontSize: "16px", color: "#333" }}>${price}</span>
    ...
    <label> Cantidad 
  <input type="number"  defaultValue={1} min={1}  style={{   width: "50px",   height: "30px",   textAlign: "center",   fontSize: "16px",   border: "1px solid #ccc",   borderRadius: "5px",   padding: "5px",   outline: "none"}}/>
  </label>
