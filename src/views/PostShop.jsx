  ...
  return (
    <div className="w-full min-h-screen bg-gray-100 font-sans flex items-center justify-center">
      <div className="max-w-6xl mx-auto p-6">
        ...
        <RedirectToWhatsapp
          num="3417120039"
          msj={`Hola acabo de realizar una compra, te brindo la url con el detalle para que la atención sea más rápida: ${import.meta.env.VITE_SHOP_URL}${location.pathname}`}
        />
